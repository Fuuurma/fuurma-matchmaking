/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 3df71ad06daa56d7a0a06f69ca2535e0)
// Runtime types generated with workerd@1.20260708.1 2026-07-10 nodejs_compat
interface __BaseEnv_Env {
	MATCHMAKING_QUEUES: DurableObjectNamespace<import("./src/index").MatchmakingQueues>;
	GAME_ROOM: DurableObjectNamespace<import("./src/index").GameRoomDO>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "MatchmakingQueues" | "GameRoomDO";
	}
